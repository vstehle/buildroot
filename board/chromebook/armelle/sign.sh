...
run $futility vbutil_kernel \
	...
	--bootloader $BINARIES_DIR/zero \
	--pack $BINARIES_DIR/uImage.kpart || exit 1

rm -f $BINARIES_DIR/kernel.its $BINARIES_DIR/zero
