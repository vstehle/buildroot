...
GRUB2_CONF_ENV = \
	CPP="$(TARGET_CC) -E" \
	TARGET_CC="$(TARGET_CC)" \
	CFLAGS="$(TARGET_CFLAGS) -Og" \
	TARGET_CFLAGS="$(TARGET_CFLAGS) -Og" \
	CPPFLAGS="$(TARGET_CPPFLAGS) -Og -fno-stack-protector" \
	TARGET_CPPFLAGS="$(TARGET_CPPFLAGS) -Og -fno-stack-protector" \
	TARGET_LDFLAGS="$(TARGET_LDFLAGS) -Og" \
	TARGET_NM="$(TARGET_NM)" \
